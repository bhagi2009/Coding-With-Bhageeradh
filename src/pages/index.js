			...
			<Stack>
				...
				<StackItem display="flex" quarkly-title="Logo" md-width="75%" width="25%">
					...
					<Link href="/" position="relative" transition="opacity 200ms ease" quarkly-title="Link">
						<Image src="https://images.unsplash.com/photo-1486312338219-ce68d2c6f44d?ixlib=rb-1.2.1&q=85&fm=jpg&crop=entropy&cs=srgb&w=2000" width="120px" z-index="3" />
					</Link>
				</StackItem>
			...
			<Stack>
				...
				>
					...
					<Text
						...
						sm-font="--base"
					>
						I am bhageeradh a certified coder and i wanted the world to see what i want to do so i started a youtube channel I will start a company one day.
					</Text>
					<Link
						href="/about"
						text-decoration-line="initial"
			...
			<Stack margin="80px -16px -16px -16px" lg-margin="50px -16px -16px -16px" md-margin="30px -16px -16px -16px">
				...
				<StackItem width="40%" display="flex" lg-margin="0px 0px 0px 0px" lg-width="100%">
					...
					<Text
						...
						sm-font="--base"
					>
						Because I also want to improve in my
					</Text>
					<Link
						href="/team"
						text-decoration-line="initial"
			...
			<Stack margin="80px -16px -16px -16px" lg-margin="50px -16px -16px -16px" md-margin="30px -16px -16px -16px">
				...
				>
					...
					<Text
						...
						sm-font="--base"
					>
						Mostly home but i work at microsoft.
					</Text>
					<Link
						href="/contact"
						text-decoration-line="initial"
